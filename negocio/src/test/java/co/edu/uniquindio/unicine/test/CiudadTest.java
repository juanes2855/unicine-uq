...
public class CiudadTest {
    ...
    public void eliminar() {
        ...
        Ciudad buscado = ciudadRepo.findById(1094899).orElse(null);
        ciudadRepo.delete(buscado);
        Assertions.assertNull(ciudadRepo.findById(1094899).orElse(null));
    }
    ...
    public void listar() {
        ...
        List<Ciudad> listaAdministradores = ciudadRepo.findAll();
